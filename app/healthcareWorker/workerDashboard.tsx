...
const HealthWorkerDashboard = () => {
  return (
    <SafeAreaView style={styles.container}>
      ...
      onPress={() => router.push("/healthcareWorker/newCase")
                
              }  >
        <View style={styles.submitCaseContent}>
          <Text style={styles.submitCaseTitle}>Submit New{'\n'}Case Report</Text>
          <Image
            source={require('@/assets/images/newCase.png')}  // Adjust path as per your structure
...
>
  <Text style={styles.newCaseButtonText}>New Case</Text>
    ...
    <TouchableOpacity onPress={() => router.push('/healthcareWorker/patientHistory')}>
  ...
  <TouchableOpacity onPressIn={()=>{router.push("/healthcareWorker/profile")}}>
